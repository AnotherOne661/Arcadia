<main>
  <section class="learn-mtg">
    <h1>Bienvenido a la Guía de Magic: The Gathering</h1>
    <div class="learn-content">
      <p>Magic: The Gathering (MTG) es un juego de cartas coleccionables en el que los jugadores asumen el papel de
        poderosos magos, conocidos como Planeswalkers, que luchan por el control de un multiverso. En esta guía te
        explicamos las reglas básicas y los formatos más populares de este juego.</p>
      <div class="card-example">
        <img src="assets/images/struc/land_footer/black-lotus.png" alt="Carta Black Lotus">
        <p>Una de las cartas más famosas de Magic: The Gathering: Black Lotus.</p>
      </div>
    </div>
    ...
    <section class="basic-rules">
      ...
      <p>Magic: The Gathering es un juego de dos o más jugadores que luchan utilizando mazos de cartas. Cada jugador
      ...
      <ul>
        ...
        <li><strong>Fase de Combate:</strong> Los jugadores resuelven los ataques y bloqueos entre las criaturas
          invocadas.</li>
        <li><strong>Fase Final:</strong> El turno del jugador termina y el siguiente jugador comienza su turno.</li>
      </ul>
    </section>
    ...
    <section class="players">
      <h2>Jugadores</h2>
      <p>El juego se juega entre dos o más jugadores. Cada jugador construye su mazo con al menos 60 cartas. Las cartas
        pueden incluir criaturas, hechizos, tierras, artefactos y encantamientos.</p>
    </section>
    ...
    <section class="requirements">
      ...
      <ul>
        ...
        <li><strong>Un campo de juego:</strong> Un espacio donde colocar las cartas, con zonas específicas para tierras,
          criaturas y hechizos.</li>
      </ul>
    </section>
    ...
    <section class="formats">
      ...
      <p>Magic: The Gathering ofrece varios formatos, cada uno con reglas y restricciones propias. A continuación, te
        explicamos los formatos más populares:</p>

      <h3>Standard</h3>
      <p>En el formato Standard, los jugadores deben construir su mazo usando cartas de las colecciones más recientes.
      ...
      <h3>Commander</h3>
      <p>En el formato Commander, los jugadores construyen mazos de 100 cartas, con un único comandante, que es una
      ...
      <h3>Pioneer</h3>
      <p>El formato Pioneer permite a los jugadores usar cartas de todas las colecciones desde la expansión de Return to
      ...
      <ul>
        ...
        <li><strong>Duración:</strong> Las partidas son generalmente más rápidas que en Commander, pero todavía tienen
          una buena cantidad de estrategia.</li>
      </ul>

      <h3>Draft</h3>
      <p>El formato Draft es un estilo de juego en el que los jugadores abren paquetes de cartas y seleccionan una carta
      ...
      <ul>
        ...
        <li><strong>Duración:</strong> El Draft es ideal para eventos rápidos y para jugadores que disfrutan de la
          experiencia de crear un mazo a partir de cartas aleatorias.</li>
      </ul>
    </section>
    ...
    <section class="video-tutorial">
      ...
      <p>Para aprender a jugar Magic: The Gathering de manera más detallada, te dejamos este video tutorial:</p>
      <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/68XopFdbxx0" frameborder="0"
