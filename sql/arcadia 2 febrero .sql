...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-02-2025 a las 21:20:42
...
('CLC', 'Charizard', 3, 'pokemon,tipo:fuego,hp:120,weakness{2},resistance{-30},retreat{3}.'),
...
('SFA', 'Bewear', 3, 'pokemon,tipo:normal,hp:130,weakness{2},retreat{3}'),
('SFA', 'Cresselia', 3, 'pokemon,tipo:psiquico,hp:120,weakness{2},retreat{1}'),
('SFA', 'Cufant', 3, 'pokemon,tipo:acero,hp:100,weakness{2},retreat{3}'),
('SFA', 'Dusclops', 3, 'pokemon,tipo:fantasma,hp:90,weakness{2},retreat{2}'),
('SFA', 'Dusknoir', 3, 'pokemon,tipo:fantasma,hp:160,weakness{2},retreat{3}'),
('SFA', 'Fezandipiti ex', 3, 'pokemon,tipo:siniestro,ex double rare,hp:210,weakness:2{F},retreat:1{N}'),
('SFA', 'Fraxure', 3, 'pokemon,tipo:dragon,hp:100,weakness{0},retreat{2}'),
('SFA', 'Horsea', 3, 'pokemon,tipo:dragon,hp:60,weakness{2},retreat{1}'),
('SFA', 'Kingdra', 3, 'pokemon,tipo:dragon,hp:310,weakness{2},retreat{1}'),
('SFA', 'Okidogi ex', 3, 'pokemon,tipo:normal,hp:250,weakness{2},retreat{3}'),
('SFA', 'Persian', 3, 'pokemon,tipo:normal,hp:110,weakness{2},retreat{1}'),
('SFA', 'Sylveon', 3, 'pokemon,tipo:hada,hp:120,weakness{2},retreat{1}'),
('SFA', 'Zorua', 3, 'pokemon,tipo:siniestro,hp:70,weakness{2},retreat{1}'),
...
('CLC', 'Charizard', 3, 74.99, 'carta', '../assets\\images\\product\\POk\\cards\\PKHC\\charizard.webp', NULL),
...
('SFA', 'Bewear', 3, 5.29, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Bewear.webp', NULL),
('SFA', 'Cresselia', 3, 13.60, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Cresselia.webp', NULL),
('SFA', 'Cufant', 3, 6.55, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Cufant.webp', NULL),
('SFA', 'Dusclops', 3, 15.36, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Dusclops.webp', NULL),
('SFA', 'Dusknoir', 3, 19.13, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Dusknoir.webp', NULL),
('SFA', 'Fezandipiti ex', 3, 7.51, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Fezandipiti_ex.webp', NULL),
('SFA', 'Fraxure', 3, 7.15, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Fraxure.webp', NULL),
('SFA', 'Horsea', 3, 15.89, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Horsea.webp', NULL),
('SFA', 'Kingdra', 3, 2.85, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\\r\nKingdra.webp', NULL),
('SFA', 'Okidogi ex', 3, 19.08, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Okidogi_ex.webp', NULL),
('SFA', 'Persian', 3, 27.78, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\persian.webp', NULL),
('SFA', 'Sylveon', 3, 0.05, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Sylveon.webp', NULL),
('SFA', 'Zorua', 3, 10.77, 'carta', '../assets\\images\\product\\POk\\cards\\SFA\\Zorua.webp', NULL),
